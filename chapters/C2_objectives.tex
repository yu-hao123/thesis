...
\begin{itemize}
    ...
    offering insights that cannot be obtained solely from statistical validation on experimental and clinical data.
\end{itemize}
...
\begin{itemize}
    ...
    noninvasive estimation of muscle effort, comparing them using both experimental and clinical data through statistical analysis.
    \item Investigate ambiguities, robustness and identifiability, evaluating how constraint design, model assumptions,
    and data characteristics influence the uniqueness and physiological plausibility of the estimated effort.
    \item Propose methodological improvements for better estimation reliability and to reduce ambiguity of noninvasive effort monitoring.
\end{itemize}